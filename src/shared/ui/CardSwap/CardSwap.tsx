...
const CardSwap: React.FC<CardSwapProps> = ({
    ...
    const refs = useMemo<CardRef[]>(() => Array.from({ length: childArr.length }).map(() => React.createRef<HTMLDivElement>()), [childArr.length]);
